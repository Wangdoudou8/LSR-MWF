...
class BartDecoder(BartPreTrainedModel):
    ...
    def __init__(self, config: BartConfig, embed_tokens: Optional[nn.Embedding] = None):
        ...
        # self.a7 = nn.Parameter(torch.tensor(0.1))
        # self.a8 = nn.Parameter(torch.tensor(0.1))
        # self.a9 = nn.Parameter(torch.tensor(0.1))
        # self.a10 = nn.Parameter(torch.tensor(0.1))
        # self.a11 = nn.Parameter(torch.tensor(0.1))
        # self.a12 = nn.Parameter(torch.tensor(0.1))
        # self.a13 = nn.Parameter(torch.tensor(0.1))
        # self.a14 = nn.Parameter(torch.tensor(0.1))
        # self.a15 = nn.Parameter(torch.tensor(0.1))
        # self.a16 = nn.Parameter(torch.tensor(0.1))
        # self.a17 = nn.Parameter(torch.tensor(0.1))
        # self.a18 = nn.Parameter(torch.tensor(0.1))
        # self.a19 = nn.Parameter(torch.tensor(0.1))
        # self.a20 = nn.Parameter(torch.tensor(0.1))
        # self.a21 = nn.Parameter(torch.tensor(0.1))
        # self.a22 = nn.Parameter(torch.tensor(0.1))
        # self.a23 = nn.Parameter(torch.tensor(0.1))
        # self.a24 = nn.Parameter(torch.tensor(0.1))
        # self.a25 = nn.Parameter(torch.tensor(0.1))
        # self.a26 = nn.Parameter(torch.tensor(0.1))
        # self.a27 = nn.Parameter(torch.tensor(0.1))
        # self.a28 = nn.Parameter(torch.tensor(0.1))
        # self.a29 = nn.Parameter(torch.tensor(0.1))
        # self.a30 = nn.Parameter(torch.tensor(0.1))
        # self.a31 = nn.Parameter(torch.tensor(0.1))
        # self.a32 = nn.Parameter(torch.tensor(0.1))
        # self.a33 = nn.Parameter(torch.tensor(0.1))
        # self.a34 = nn.Parameter(torch.tensor(0.1))
        # self.a35 = nn.Parameter(torch.tensor(0.1))
        # self.a36 = nn.Parameter(torch.tensor(0.1))
    ...
    def forward(
        ...
        for idx, decoder_layer in enumerate(self.layers):
            ...
            if self.gradient_checkpointing and self.training:
                ...
                # if idx == 0:
                #     new_encoder_hidden_states = encoder_hidden_states + self.a1 * topic_hidden_states + self.a2 * sent_hidden_states + self.a3 * tri_hidden_states
                # elif idx == 1:
                #     new_encoder_hidden_states = encoder_hidden_states + self.a4 * topic_hidden_states + self.a5 * sent_hidden_states + self.a6 * tri_hidden_states
                # elif idx == 2:
                #     new_encoder_hidden_states = encoder_hidden_states + self.a7 * topic_hidden_states + self.a8 * sent_hidden_states + self.a9 * tri_hidden_states
                # elif idx == 3:
                #     new_encoder_hidden_states = encoder_hidden_states + self.a10 * topic_hidden_states + self.a11 * sent_hidden_states + self.a12 * tri_hidden_states
                # elif idx == 4:
                #     new_encoder_hidden_states = encoder_hidden_states + self.a13 * topic_hidden_states + self.a14 * sent_hidden_states + self.a15 * tri_hidden_states
                # elif idx == 5:
                #     new_encoder_hidden_states = encoder_hidden_states + self.a16 * topic_hidden_states + self.a17 * sent_hidden_states + self.a18 * tri_hidden_states
                # elif idx == 6:
                #     new_encoder_hidden_states = encoder_hidden_states + self.a19 * topic_hidden_states + self.a20 * sent_hidden_states + self.a21 * tri_hidden_states
                # elif idx == 7:
                #     new_encoder_hidden_states = encoder_hidden_states + self.a22 * topic_hidden_states + self.a23 * sent_hidden_states + self.a24 * tri_hidden_states
                # elif idx == 8:
                #     new_encoder_hidden_states = encoder_hidden_states + self.a25 * topic_hidden_states + self.a26 * sent_hidden_states + self.a27 * tri_hidden_states
                # elif idx == 9:
                #     new_encoder_hidden_states = encoder_hidden_states + self.a28 * topic_hidden_states + self.a29 * sent_hidden_states + self.a30 * tri_hidden_states
                # elif idx == 10:
                #     new_encoder_hidden_states = encoder_hidden_states + self.a31 * topic_hidden_states + self.a32 * sent_hidden_states + self.a33 * tri_hidden_states
                # elif idx == 11:
                #     new_encoder_hidden_states = encoder_hidden_states + self.a34 * topic_hidden_states + self.a35 * sent_hidden_states + self.a36 * tri_hidden_states
...
class CombinationModel(BartPreTrainedModel):
    ...
    def forward(
        ...
        if masked_lm_loss is None:
            loss = None
        elif topic_loss is not None:
            loss = masked_lm_loss + topic_loss + sent_loss + tri_loss
        else:
            loss = masked_lm_loss
